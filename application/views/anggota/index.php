...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-3 ml-4">
        <h1 class="h2 mb-0 text-gray-800">Data Anggota</h1>
        <div class="row mx-3">
        ...
        <a href="<?= base_url() ?>anggota/tambah" class="align-items-center ml-3 btn btn-sm btn-primary btn-icon-split">
        ...
        <div class="card border-bottom-primary shadow mb-4">
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-hover" id="dtHorizontalExample" width="100%" cellspacing="0" data-searching="false">
                        <thead>
                            <tr>
                                <th width="1%">No</th>
                                <th>Foto</th>
                        ...
                        <tbody style="cursor:pointer;" id="tbody"> 
                            ...
                            <tr>
                                ...
                                <td onclick="detail('<?= $a->id_anggota ?>')"><img style="border-radius: 5px;" src="<?= base_url() ?>assets/upload/anggota/<?= $a->foto ?>" alt=""
                                        width="75px"></td>
