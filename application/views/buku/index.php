...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between ml-3 mb-4">
        <h1 class="h2 mb-0 text-gray-800">Data Buku</h1>
        <div class="row mx-3">
        ...
        <a href="<?= base_url() ?>buku/tambah"  class="align-items-center btn btn-sm btn-primary ml-3 btn-icon-split">
                        ...
                        <tbody style="cursor:pointer;">
                            ...
                            <tr>
                                ...
                                <td onclick="detail('<?= $b->id_buku ?>')"><img style="border-radius: 5px;"
                                        src="<?= base_url() ?>assets/upload/buku/<?= $b->foto ?>" alt="" width="75px"></td>
