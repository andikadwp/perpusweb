    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-md-6 mb-4" id="anggota">
            <div class="card border-left-primary shadow h-100 py-2">
                ...
                <a href="anggota" class="card-footer text-xs font-weight-bold text-primary text-uppercase pt-2 text-center " style="height: 5px; text-decoration:none">Lihat Info <i class="fa fa-eye"></i></a>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6 mb-4" id="buku">
            <div class="card border-left-success shadow h-100 py-2">
                ...
                <a href="buku" class="card-footer text-xs font-weight-bold text-success text-uppercase pt-2 text-center " style="height: 3px; text-decoration:none">Lihat Info <i class="fa fa-eye"></i></a>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6 mb-4" id="pengadaan">
            <div class="card border-left-info shadow h-100 py-2">
                ...
                <a href="pengadaan" class="card-footer text-xs font-weight-bold text-info text-uppercase pt-2 text-center " style="height: 3px; text-decoration:none">Lihat Info <i class="fa fa-eye"></i></a>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6 mb-4" id="pinjam">
            <div class="card border-left-warning shadow h-100 py-2">
                ...
                <a href="peminjaman" class="card-footer text-xs font-weight-bold text-warning text-uppercase pt-2 text-center " style="height: 3px; text-decoration:none">Lihat Info <i class="fa fa-eye"></i></a>
            </div>
        </div>
    </div>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <center>
                            <a href="<?= base_url() ?>buku" class="btn btn-info btn-md">
                                <i class="fa fa-eye"></i>
                                Lihat semua buku
                            </a>
                        </center>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <center>
                            <a href="<?= base_url() ?>peminjaman" class="btn btn-info btn-md">
                                <i class="fa fa-eye"></i>
