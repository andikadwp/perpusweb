...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between ml-3 mb-4">
        <h1 class="h2 mb-0 text-gray-800">Data Pengguna</h1>
        <a href="<?= base_url() ?>user/tambah" class="btn btn-sm btn-primary mr-3 btn-icon-split">
                    ...
                    <table class="table table-hover" id="dtHorizontalExample" width="100%" cellspacing="0">
                        ...
                        <tbody style="cursor:pointer;" id="tbody"> 
                            ...
                            <tr>
                                ...
                                <td onclick="detail('<?= $u->id_user ?>')"><?= $u->username ?></td>
